...
image = cv2.imread('images4report/depth.jpg')
...
# draw_box_cal(image, [236,331,271,399])
...
# image = cv2.putText(image,'Object lamp has mean center = 99.38',(150,16+30),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2,cv2.LINE_AA)
...
cv2.imwrite('images4report/figure_7.jpg', image)
